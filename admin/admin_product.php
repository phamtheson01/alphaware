...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="number" name="qty" placeholder="Vị trí trong stock" style="width:250px;" required></td>
							</tr>
							<tr>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Giày bóng rổ</h2></center></div>
			<br />
