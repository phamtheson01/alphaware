...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="number" name="qty" placeholder="Vị trí stock" style="width:250px;" required></td>
							</tr>
							<tr>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Sản phẩm tiềm năng</h2></center></div>
			<br />
				<label  style="padding:5px; float:right;"><input type="text" name="filter" placeholder="Tìm sản phẩm ở đây" id="filter"></label>
			<br />
...
<script type="text/javascript">
	$(document).ready( function() {
		...
		if(confirm("Bạn có chắc muốn xóa sản phẩm không?")){
			...
			$(".del"+id).fadeOut(1000, function(){ $(this).remove();}); 
			}
			}); 
			}else{
			return false;}
