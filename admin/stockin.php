<!--Add Administrator facebox-->
  ...
  $id = $_GET['id'];
  ?>
	<div class="login_title"><span>Hàng vào</span></div>
	<br>
		<form method="post" >
			<table class="login">
				...
				<tr><td><button name="stockin" type="submit" class="btn btn-block btn-large btn-info"><i class="icon-ok-sign icon-white"></i> Lưu dữ liệu</button></td></tr>
			</table>
		</form>
  </div><!--/end facebox-->	
